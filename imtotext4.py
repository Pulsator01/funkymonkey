...
for bbox, text, confidence in result:
    ...
    resized_image = cv2.rectangle(resized_image, top_left, bottom_right, (0, 255, 0), 2)
    cv2.putText(
        resized_image, text, top_left, cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 0), 2, cv2.LINE_AA
    )
